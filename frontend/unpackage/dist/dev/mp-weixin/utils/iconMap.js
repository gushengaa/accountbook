...
function getBookCategoryColor(category) {
...
function getBookCategoryBadgeStyle(category) {
...
function getBookCardTintStyle(category) {
  const color = getBookCategoryColor(category);
  return {
    "--book-accent": color,
...
function isIconClass(value) {
  if (!value)
    return false;
  return /^(ri-|icon-)/.test(value) || APP_ICONS[value] !== void 0;
}
function resolveIconClass({ name, icon, categoryName, filled = false } = {}) {
  let base = "";
  if (name) {
...
exports.getBookCardTintStyle = getBookCardTintStyle;
exports.getBookCategoryBadgeStyle = getBookCategoryBadgeStyle;
exports.getBookCategoryEmoji = getBookCategoryEmoji;
exports.resolveIconClass = resolveIconClass;
//# sourceMappingURL=../../.sourcemap/mp-weixin/utils/iconMap.js.map
